 ...
 * 2004-06-29
 * modification of resizing parameters to have a a max width or height
 */
 ...
 * @version CVS $Id: ImageReader.java,v 1.1 2004/04/30 16:49:48 frederic Exp $
 */
final public class ImageReader extends ResourceReader {
     ...
     *
     * 2004-04-12 frederic.glorieux@ajlsm.com
     * default preserve ratio
     */
    private AffineTransform getTransform(double ow, double oh, double nw, double nh) {

		double wm = 1.0d;
		double hm = 1.0d;
		/* ratio to find is the one enough to put the image 
		 * in nw and nh
		 * 
		 */
		double ratio = 1.0d;
