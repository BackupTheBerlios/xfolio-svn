...
<!-- ********************************************************************
     $Id: titlepage.xsl,v 1.1 2004/06/10 10:10:27 frederic Exp $
     ********************************************************************
...
<xsl:template match="address" mode="titlepage.mode">
  ...
  <xsl:choose>
    <xsl:when test="string($suppress-numbers) = '0'
                    and @linenumbering = 'numbered'
                    and string($use.extensions) != '0'
                    and string($linenumbering.extension) != '0'">
      <div class="{name(.)}">
...
<xsl:template match="year" mode="titlepage.mode">
  <xsl:choose>
    <xsl:when test="string($show.revisionflag) != '0' and @revisionflag">
...
<xsl:template match="legalnotice" mode="titlepage.mode">
  ...
  <xsl:choose>
    <xsl:when test="string($generate.legalnotice.link) != '0'">
