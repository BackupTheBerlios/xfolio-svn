...
The Java(TM) 2 Runtime Environment (JRE) is intended for software developers 
...
In addition, Java Web Start files may be excluded.
They are located as follows:

Windows SDK installation:
   <drive>:\j2sdk1.5.0\jre\javaws<br>
   <drive>:\Program Files\Java\j2re1.5.0\javaws
Solaris/Linux SDK installation:
   <installation directory>/j2sdk1.5.0/jre/javaws
